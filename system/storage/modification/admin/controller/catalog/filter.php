...
class ControllerCatalogFilter extends Controller {
	...
	protected function getList() {
		...
		// LMCfilter BEGIN
        $data['add_LMCfilter_price'] = $this->url->link('catalog/LMCfilter/add_price', 'token=' . $this->session->data['token'] . $url, true);
        // LMCfilter END
		...
		foreach ($results as $result) {
			$data['filters'][] = array(
				...
				// LMCfilter BEGIN
				'edit'            => $this->url->link($result['LMCfilter_mode'] == null ? 'catalog/filter/edit' : 'catalog/LMCfilter/edit_' . $result['LMCfilter_mode'], 'token=' . $this->session->data['token'] . '&filter_group_id=' . $result['filter_group_id'] . $url, true)
				// LMCfilter END
