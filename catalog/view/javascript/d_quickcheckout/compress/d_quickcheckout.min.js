...
var telephone=$('input[type=tel]');},setDateTime:function(){var that=this;$('.date',this.el).datetimepicker({pickTime:false,dateFormat:"mm/DD/YYYY",})
...
validateTelephone:function(e){if($.trim($(e.currentTarget).val())){this.updateField(e);}},
