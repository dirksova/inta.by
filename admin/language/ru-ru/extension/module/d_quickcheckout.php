...
//update
    ...
    $_['compress_update'] = 'Сгенерировать кеш';
...
//debug
    ...
    $_['success_clear_debug_file'] = 'Файл очищен.';
...
//general
    ...
    $_['entry_general_clear_session'] = 'Очистить данные после обновления страницы:';
    $_['help_general_clear_session'] = 'When enabled, after the checkout page is refreshed - the personal data will be cleared.';
    $_['entry_general_login_refresh'] = 'Обновить страницу после авторизации:';
    ...
    $_['entry_action_bulk_setting'] = 'Сохранить/восстановить настройки:';
...
//payment_method
    ...
    $_['callout_payment_payment_popup'] = '<h3>Способы оплаты в popup-окне</h3><br><p>Способы оплаты включаються в разделе Модули > Оплата. Здесь можно только включить отображение дополнительной информации способов оплаты во всплывающем окне.</p>';
...
// Entry
    ...
    $_['entry_shipping'] = 'Адрес клиента и адрес доставки один и тот же';
