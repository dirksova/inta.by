          ...
          <div class="tab-content">
            ...
            <div class="tab-pane" id="tab-store">
              ...
              <div class="form-group required">
			   ...
			   <div class="form-group ">
                <label class="col-sm-2 control-label" for="input-foot">Текст в подвале (лицензия, УНП и прочее)</label>
                <div class="col-sm-10">
                  <input type="text" name="config_foot" value="<?php echo $config_foot; ?>" id="input-foot" class="form-control" />
              ...
              <div class="form-group ">
                <label class="col-sm-2 control-label" for="input-vk">Ссылка на vkontakte</label>
                <div class="col-sm-10">
              ...
              <div class="form-group ">
                <label class="col-sm-2 control-label" for="input-fb">Ссылка на  facebook</label>
                <div class="col-sm-10">
                  <input type="text" name="config_fb" value="<?php echo $config_fb; ?>" id="input-fb" class="form-control" />
                 
                </div>
              </div>
              <div class="form-group ">
                <label class="col-sm-2 control-label" for="input-ok">Ссылка на   odnoklassniki</label>
                <div class="col-sm-10">
                  <input type="text" name="config_ok" value="<?php echo $config_ok; ?>"  id="input-ok" class="form-control" />
                  
                </div>
              </div>
              <div class="form-group ">
                <label class="col-sm-2 control-label" for="input-tw">Телефон в viber (пример: +375291234567)</label>
                <div class="col-sm-10">
                  <input type="text" name="config_tw" value="<?php echo $config_tw; ?>" id="input-tw" class="form-control" />
               
                </div>
              </div>
              <div class="form-group ">
                <label class="col-sm-2 control-label" for="input-in">Ссылка на   instagram</label>
                <div class="col-sm-10">
                  <input type="text" name="config_in" value="<?php echo $config_in; ?>" id="input-in" class="form-control" />
