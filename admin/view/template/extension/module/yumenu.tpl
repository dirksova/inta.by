            ...
            <div id="tab-menu-structure" class="tab-pane output-forms">
              ...
              <div class="item-option" id="categories-option" <?php echo isset($structure['items']) && $structure['items'] == 'categories' ? '' : 'style="display:none;"'; ?>>
                <div class="form-group">
                  <div class="col-md-9 col-lg-10 col-md-offset-3 col-lg-offset-2">
                    <div class="btn-group" data-toggle="buttons">
                      <label class="btn btn-default arrow-bottom">
                        <input type="radio" name="structure[cat_option]" value="selective" <?php echo empty($structure['cat_option']) || $structure['cat_option'] == 'selective' ? 'checked="checked"' : ''; ?> onchange="if($(this).prop('checked')) {$('#categories-selective').show().siblings('.cat-options').hide(); $('#nesting-levels').hide();}" />
                        <?php echo $text_selective; ?>
                      </label>
                      <label class="btn btn-default arrow-bottom">
                        <input type="radio" name="structure[cat_option]" value="parent" <?php echo isset($structure['cat_option']) && $structure['cat_option'] == 'parent' ? 'checked="checked"' : ''; ?> onchange="if($(this).prop('checked')) {$('#categories-parent').show().siblings('.cat-options').hide();$('#nesting-levels').show();}" />
                        <?php echo $text_parent; ?>
                      </label>
                      <label class="btn btn-default arrow-bottom">
                        <input type="radio" name="structure[cat_option]" value="current" <?php echo isset($structure['cat_option']) && $structure['cat_option'] == 'current' ? 'checked="checked"' : ''; ?> onchange="if($(this).prop('checked')) {$('#categories-current').show().siblings('.cat-options').hide();$('#nesting-levels').show();}" />
                        <?php echo $text_current; ?>
                      </label>
                      <label class="btn btn-default arrow-bottom">
                        <input type="radio" name="structure[cat_option]" value="subcurrent" <?php echo isset($structure['cat_option']) && $structure['cat_option'] == 'subcurrent' ? 'checked="checked"' : ''; ?> onchange="if($(this).prop('checked')) {$('#categories-subcurrent').show().siblings('.cat-options').hide();$('#nesting-levels').show();}" />
                        <?php echo $text_subcurrent; ?>
                      </label>
                      <label class="btn btn-default arrow-bottom">
                        <input type="radio" name="structure[cat_option]" value="levels" <?php echo isset($structure['cat_option']) && $structure['cat_option'] == 'levels' ? 'checked="checked"' : ''; ?> onchange="if($(this).prop('checked')) {$('#categories-levels').show().siblings('.cat-options').hide();$('#nesting-levels').hide();}" />
                        <?php echo $text_range; ?>
                      </label>
                    </div>
                  </div>
                ...
                <div class="row">
                  <div class="col-md-9 col-lg-10 col-md-offset-3 col-lg-offset-2">
                    <label class="checkbox-inline">
                      <input type="checkbox" name="menu[products_count]" value="1" id="cats-pc" onchange="if($(this).prop('checked')){$('#custom-cats-pc').prop('checked', true);} else {$('#custom-cats-pc').prop('checked',false);}" <?php echo isset($menu['products_count']) ? 'checked="checked"' : ''; ?> />
                      <?php echo $text_products_count; ?> </label>
                    <label class="checkbox-inline">
              ...
              <div class="item-option" id="manufacturers-option" <?php echo isset($structure['items']) && $structure['items'] == 'manufacturers' ? '' : 'style="display:none;"'; ?>>
                <div class="row">
                  <div class="col-md-9 col-lg-10 col-md-offset-3 col-lg-offset-2">
                    <label class="checkbox-inline">
                      <input type="checkbox" name="menu[brands_count]" value="1" id="brands-pc" onchange="if($(this).prop('checked')){$('#custom-brands-pc').prop('checked', true);} else {$('#custom-brands-pc').prop('checked',false);}" <?php echo isset($menu['brands_count']) ? 'checked="checked"' : ''; ?> />
                      <?php echo $text_brands_count; ?> </label>
                    <label class="checkbox-inline">
                    ...
                    <div class="tab-content">
                      <div class="tab-pane active" id="categories">
                        <div style="margin: -6px 0 10px 0;">
                          <label class="checkbox-inline">
                            <input type="checkbox" value="1" id="custom-cats-pc" onchange="if($(this).prop('checked')){$('#cats-pc').prop('checked', true);} else {$('#cats-pc').prop('checked',false);}" <?php echo isset($menu['products_count']) ? 'checked="checked"' : ''; ?> />
                            <?php echo $text_products_count; ?> </label>
                          <label class="checkbox-inline">
                      ...
                      <div class="tab-pane" id="manufacturers">
                        <div style="margin: -6px 0 10px 0;">
                          <label class="checkbox-inline">
                            <input type="checkbox" value="1" id="custom-brands-pc" onchange="if($(this).prop('checked')){$('#brands-pc').prop('checked', true);} else {$('#brands-pc').prop('checked',false);}" <?php echo isset($menu['brands_count']) ? 'checked="checked"' : ''; ?> />
                            <?php echo $text_brands_count; ?> </label>
                          <label class="checkbox-inline">
                        ...
                        <div class="tab-content">
                          ...
                          <div class="tab-pane" id="lang-sel-<?php echo $language['language_id']; ?>">
                            ...
                            <div class="row">
                              ...
                              <p class="col-sm-8 code-icon-sel-<?php echo $language['language_id']; ?>">
                                <input type="text" name="code<?php echo $language['language_id']; ?>" class="form-control" />
                              </p>
                              <p class="col-sm-8 img-icon-sel-<?php echo $language['language_id']; ?>" style="display: none;">
                ...
                <div class="col-lg-6">
                  <div class="form-group">
                    ...
                    <div class="col-md-9 col-lg-8">
                      <select name="menu[type]" class="form-control" onchange="if ($(this).val()=='vertical') {$('#vertical-type').show(); $('#horizontal-type').hide(); $('#showcase-type').hide();} else if ($(this).val()=='horizontal') {$('#horizontal-type').show(); $('#vertical-type').hide(); $('#showcase-type').hide(); } else {$('#horizontal-type').hide(); $('#vertical-type').hide(); $('#showcase-type').show();}">
                        <?php if (isset($menu['type']) && $menu['type'] == 'vertical') { ?>
                        <option value="vertical" selected="selected"><?php echo $text_vertical; ?></option>
                        <?php } else { ?>
                        <option value="vertical"><?php echo $text_vertical; ?></option>
                        <?php } ?>
                        <?php if (isset($menu['type']) && $menu['type'] == 'horizontal') { ?>
                        ...
                        <?php } ?>
                        <?php if (isset($menu['type']) && $menu['type'] == 'showcase') { ?>
                  ...
                  <div id="vertical-type" <?php echo empty($menu['type']) || $menu['type'] == 'vertical' ? '' : 'style="display:none;"'; ?>>
                    <div class="form-group" style="border-top: 1px solid #ededed;">
                      <label class="col-md-3 col-lg-4 control-label"><?php echo $entry_view; ?></label>
                      <div class="col-md-9 col-lg-8">
                        <select name="menu[minimized]" class="form-control">
                          <?php if (!empty($menu['minimized'])) { ?>
                        ...
                        <div class="checkbox">
                          <label style="margin-top:12px;">
                            <input type="checkbox" name="menu[save_view]" value="1" <?php echo isset($menu['save_view']) ? 'checked="checked"' : ''; ?> />
                    ...
                    <div class="form-group">
                      ...
                      <div class="col-md-9 col-lg-8">
                        <select name="menu[design]" class="form-control" onchange="if ($(this).val()=='am') {$('#accordion-config').show(); $('#flyout-config').hide();} else if ($(this).val()=='fm') {$('#flyout-config').show(); $('#accordion-config').hide();} else {$('#accordion-config,#flyout-config').hide();}">
                    ...
                    <div id="flyout-config" <?php echo isset($menu['design']) && $menu['design'] == 'fm' ? '' : 'style="display:none;"'; ?>>
                      <div class="form-group" style="border-top: 1px solid #ededed;">
                        <label class="col-md-3 col-lg-4 control-label"><?php echo $entry_column; ?></label>
                        <div class="col-md-9 col-lg-8">
                          <input type="text" name="menu[column]" value="<?php echo !empty($menu['column']) ? $menu['column'] : '1'; ?>" class="form-control" />
                        </div>
                      </div>
                    </div>
                    <div class="form-group"  style="border-top: 1px solid #ededed;">
                      <label class="col-md-3 col-lg-4 control-label"><?php echo $entry_icons; ?></label>
                      <div class="col-md-9 col-lg-8">
                        <select name="menu[icon_status]" class="form-control">
                          <?php if (!empty($menu['icon_status'])) { ?>
                    ...
                    <div class="form-group">
                      ...
                      <div class="col-md-9 col-lg-8">
                      <input type="text" name="menu[box_class]" value="<?php echo !empty($menu['box_class']) ? $menu['box_class'] : 'panel panel-default'; ?>" class="form-control" />
                      </div>
                    </div>
                    <div class="form-group">
                      <label class="col-md-3 col-lg-4 control-label"><?php echo $entry_title_class; ?></label>
                      <div class="col-md-9 col-lg-8">
                      <input type="text" name="menu[title_class]" value="<?php echo !empty($menu['title_class']) ? $menu['title_class'] : 'panel-heading'; ?>" class="form-control" />
                      </div>
                    </div>
                  </div>
                  <div id="horizontal-type" <?php echo isset($menu['type']) && $menu['type'] == 'horizontal' ? '' : 'style="display:none;"'; ?>>
                    <div class="form-group" style="border-top: 1px solid #ededed;">
                    ...
                    <div class="form-group">
                      <label class="col-md-3 col-lg-4 control-label"><?php echo $entry_images; ?></label>
                      <div class="col-md-9 col-lg-8">
                        <div class="row">
                          <div class="col-sm-6">
                            <select name="menu[hm_img_status]" class="form-control">
                              <?php if (!empty($menu['hm_img_status'])) { ?>
                              <option value="1" selected="selected"><?php echo $text_enabled; ?></option>
                              <option value="0"><?php echo $text_disabled; ?></option>
                              <?php } else { ?>
                              <option value="1"><?php echo $text_enabled; ?></option>
                          ...
                          <div class="col-sm-6">
                           <div class="row">
                             <div class="col-sm-6"><input type="text" name="menu[hm_img_width]" value="<?php echo !empty($menu['hm_img_width']) ? $menu['hm_img_width'] : '100'; ?>" class="form-control" /></div>
                             <div class="col-sm-6"><input type="text" name="menu[hm_img_height]" value="<?php echo !empty($menu['hm_img_height']) ? $menu['hm_img_height'] : '100'; ?>" class="form-control" /></div>
                           </div>
                         </div>
                        </div>
                      </div>
                    ...
                    <div class="form-group">
                      ...
                      <div class="col-md-9 col-lg-8">
                        <div class="row">
                          <div class="col-sm-6">
                            <input type="text" name="menu[column_hm]" value="<?php echo !empty($menu['column_hm']) ? $menu['column_hm'] : '2'; ?>" class="form-control" onkeyup="if ($(this).val()<2) {$('#full-width-input').prop('disabled', true); $('#full-width-input').parent().addClass('disabled').css('opacity','.5');} else {$('#full-width-input').prop('disabled', false); $('#full-width-input').parent().removeClass('disabled').css('opacity','1');}" />
                          </div>
                          <div class="col-sm-6">
                          <div id="full-width">
                            <label class="checkbox-inline <?php echo !empty($menu['column_hm']) && $menu['column_hm'] < 2 ? 'disabled' : ''; ?>" <?php echo !empty($menu['column_hm']) && $menu['column_hm'] < 2 ? 'style="opacity:.5"' : 'style="opacity:1"'; ?>>
                              <input type="checkbox" name="menu[full_width]" value="1" id="full-width-input" <?php echo isset($menu['full_width']) ? 'checked="checked"' : ''; ?> <?php echo !empty($menu['column_hm']) && $menu['column_hm'] < 2 ? 'disabled' : ''; ?> />
                              <?php echo $text_full_width; ?> </label></div>
                          </div>
                        </div>
                      </div>
                    </div>
                    <div class="form-group">
                      <label class="col-md-3 col-lg-4 control-label"><?php echo $entry_box_class; ?></label>
                      <div class="col-md-9 col-lg-8">
                      <input type="text" name="menu[box_class_hm]" value="<?php echo isset($menu['box_class_hm']) ? $menu['box_class_hm'] : 'yumenu'; ?>" class="form-control" />
                      </div>
                    </div>
                  </div>
                  <div id="showcase-type" <?php echo isset($menu['type']) && $menu['type'] == 'showcase' ? '' : 'style="display:none;"'; ?>>
                    <div class="form-group" style="border-top: 1px solid #ededed;">
                      <label class="col-md-3 col-lg-4 control-label"><?php echo $entry_images; ?></label>
                      <div class="col-md-9 col-lg-8">
                        <div class="btn-group btn-group-justified" data-toggle="buttons">
                          <label class="btn btn-default">
                            <input type="radio" name="sc[img_position]" value="top" <?php echo empty($sc['img_position']) || $sc['img_position'] == 'top' ? 'checked="checked"' : ''; ?> />
                            <?php echo $text_top; ?> </label>
                          <label class="btn btn-default">
                            <input type="radio" name="sc[img_position]" value="bottom" <?php echo isset($sc['img_position']) && $sc['img_position'] == 'bottom' ? 'checked="checked"' : ''; ?> />
                            <?php echo $text_bottom; ?> </label>
                          <label class="btn btn-default">
                            <input type="radio" name="sc[img_position]" value="left" <?php echo isset($sc['img_position']) && $sc['img_position'] == 'left' ? 'checked="checked"' : ''; ?> />
                            <?php echo $text_left; ?> </label>
                          <label class="btn btn-default">
                            <input type="radio" name="sc[img_position]" value="right" <?php echo isset($sc['img_position']) && $sc['img_position'] == 'right' ? 'checked="checked"' : ''; ?> />
                            <?php echo $text_right; ?> </label>
                        </div>
                      </div>
                      <div class="col-md-9 col-lg-8 col-md-offset-3 col-lg-offset-4" style="margin-top: 16px;">
                        <div class="row">
                          <div class="col-sm-6">
                            <select name="sc[img_status]" class="form-control">
                              <?php if (!empty($sc['img_status'])) { ?>
                              <option value="1" selected="selected"><?php echo $text_enabled; ?></option>
                              <option value="0"><?php echo $text_disabled; ?></option>
                              <?php } else { ?>
                              <option value="1"><?php echo $text_enabled; ?></option>
                          ...
                          <div class="col-sm-6">
                           <div class="row">
                             <div class="col-sm-6"><input type="text" name="sc[img_width]" value="<?php echo !empty($sc['img_width']) ? $sc['img_width'] : '200'; ?>" class="form-control" /></div>
                             <div class="col-sm-6"><input type="text" name="sc[img_height]" value="<?php echo !empty($sc['img_height']) ? $sc['img_height'] : '200'; ?>" class="form-control" /></div>
                           </div>
                         </div>
                        </div>
                      </div>
                    ...
                    <div class="form-group">
                      <label class="col-md-3 col-lg-4 control-label"><?php echo $entry_subitems; ?></label>
                      <div class="col-md-9 col-lg-8">
                        <div class="btn-group btn-group-justified" data-toggle="buttons">
                          <label class="btn btn-default">
                            <input type="radio" name="sc[subview]" value="list" <?php echo empty($sc['subview']) || $sc['subview'] == 'list' ? 'checked="checked"' : ''; ?> />
                            <?php echo $text_list; ?> </label>
                          <label class="btn btn-default">
                            <input type="radio" name="sc[subview]" value="grid" <?php echo isset($sc['subview']) && $sc['subview'] == 'grid' ? 'checked="checked"' : ''; ?> />
                            <?php echo $text_grid; ?> </label>
                        </div>
                      </div>
                      <div class="col-md-9 col-lg-8 col-md-offset-3 col-lg-offset-4" style="margin-top: 16px;">
                        <div class="row">
                          <div class="col-sm-6">
                            <div class="input-group">
                              ...
                              <input type="text" name="sc[sublimit]" value="<?php echo !empty($sc['sublimit']) ? $sc['sublimit'] : ''; ?>" class="form-control text-center" />
                            </div>
                          </div>
                          <div class="col-sm-6">
                            <label class="checkbox-inline" />
                            <input type="checkbox" name="sc[more_btn]" value="1" <?php echo isset($sc['more_btn']) ? 'checked="checked"' : ''; ?> />
                    ...
                    <div class="form-group">
                      <label class="col-md-3 col-lg-4 control-label"><?php echo $entry_box_class; ?></label>
                      <div class="col-md-9 col-lg-8">
                      <input type="text" name="sc[box_class]" value="<?php echo !empty($sc['box_class']) ? $sc['box_class'] : 'showcase'; ?>" class="form-control" />
                      </div>
                    </div>
                  </div>
                </div>
              ...
              <div class="row">
                <div class="col-lg-6">
                  ...
                  <label class="col-md-3 col-lg-4 control-label"><span data-toggle="tooltip" title="<?php echo $help_style; ?>"><?php echo $entry_css_url; ?></span></label>
                    <div class="col-md-9 col-lg-8">
                      <input type="text" name="module[css_url]" value="<?php echo !empty($module['css_url']) ? $module['css_url'] : ''; ?>" class="form-control" />
                    </div>
                  </div>
                  <div class="form-group">
                  <label class="col-md-3 col-lg-4 control-label"><span data-toggle="tooltip" title="<?php echo $help_script; ?>"><?php echo $entry_js_url; ?></span></label>
                    <div class="col-md-9 col-lg-8">
                      <input type="text" name="module[js_url]" value="<?php echo !empty($module['js_url']) ? $module['js_url'] : ''; ?>" class="form-control" />
                    </div>
                  </div>
                  <div class="form-group">
                ...
                <div class="col-lg-6">
                  <div class="form-group">
                    ...
                    <div class="col-md-9 col-lg-8">
                      ...
                      <div class="well well-sm" style="min-height: 80px;">
